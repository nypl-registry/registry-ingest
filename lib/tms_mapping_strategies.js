...
exports.accessionToCallnumber = function(cb){
	...
	db.returnCollectionRegistry("shadowcatMaterialKLookup",function(err,shadowcatMaterialKLookup,shadowcatMaterialKLookupDatabase){
		...
		cursor.once('end', function() {
			...
			db.returnCollectionRegistry("tmsObjects",function(err,tmsObjects,tmsObjectsDatabase){
...
exports.buildShadowcatMaterialKLookup = function(cb){
	...
	db.returnCollectionRegistry("shadowcatMaterialKLookup",function(err,shadowcatMaterialKLookup,shadowcatMaterialKLookupDatabase){
		...
		shadowcatMaterialKLookup.remove({},function(err,results){
			...
			db.returnCollectionRegistryShadowcat("bib",function(err,shadowcatBib,shadowcatDatabase){
