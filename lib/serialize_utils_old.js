			...
			cursor.on('data', function(collection) {
				...
				shadowcatBib.find({ _id : bNumber}).toArray(function(err, bibs) {
					...
					if (collection.mss){
						...
						triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:msscoll:" + collection.mss, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
					}
					if (collection.bNumber){
						triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:bnum:" + collection.bNumber, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
					}
					if (collection.callNumber){
						triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:callnum:" + collection.callNumber.replace(/\s/g,''), objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
					}
					if (collection.matchedMms){
						triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:uuid:" + collection.mmsUuid, objectLiteral :  null,  literalDataType: null, prov: collectionMmsProv  })
					}
					...
					collection.dates.map(function(d){
						if (parseInt(d.value) != 0){
							if (d.point=='start'){
								triples.push({  subject: collectionUri,  predicate: "dbo:yearStart", objectUri: null, objectLiteral :  d.value,  literalDataType: "xsd:date", prov: collectionProv  })
							}
							if (d.point=='end'){
								triples.push({  subject: collectionUri,  predicate: "dbo:yearEnd", objectUri: null, objectLiteral :  d.value,  literalDataType: "xsd:date", prov: collectionProv  })
							}
							if (d.point=='exact'){
					...
					function(err, results) {
						...
						componentCursor.on('data', function(component) {
							...
							triples.push({  subject: componentUri,  predicate: "dcterms:identifier", objectUri: "u:superparent:" + collectionRegistryId, objectLiteral :  null,  literalDataType: null, prov: componentProv  })
							...
							if (component.mss){
								...
								triples.push({  subject: componentUri,  predicate: "dcterms:identifier", objectUri: "u:msscoll:" + component.mss, objectLiteral :  null,  literalDataType: null, prov: componentProv  })
							}
							if (component.barcode){
								triples.push({  subject: componentUri,  predicate: "dcterms:identifier", objectUri: "u:barcode:" + component.barcode, objectLiteral :  null,  literalDataType: null, prov: componentProv  })
							}
							...
							component.dates.map(function(d){
								if (d.point=='start'){
									...
									triples.push({  subject: componentUri,  predicate: "dbo:yearStart", objectUri: null, objectLiteral :  d.value,  literalDataType: "xsd:date", prov: componentProv  })
								}
								if (d.point=='end'){
									addedDates.push(d.value)
									triples.push({  subject: componentUri,  predicate: "dbo:yearEnd", objectUri: null, objectLiteral :  d.value,  literalDataType: "xsd:date", prov: componentProv  })
								}
								if (d.point=='exact'){
									addedDates.push(d.value)
									...
									if (component.matchedMmsType == 'containerMerge'){
										...
										databaseMmsItems.find( { parents : component.mmsUuid } ).toArray(function(err, mssItems){
											...
											async.eachSeries(mssItems, function(aMssItem, eachCallback) {
												...
												triples.push({  subject: nyplItem,  predicate: "dcterms:identifier", objectUri: "u:superparent:" + collectionRegistryId, objectLiteral :  null,  literalDataType: null, prov: componentMmsProv  })
										...
										databaseMmsItems.find({ $or : [ { archivesComponentDb: component.mssDb }, { _id: component.mmsUuid}] }).toArray(function(err, mssItem){
											...
											if (mssItem.length==1){
												...
												triples.push({  subject: componentUri,  predicate: "dcterms:identifier", objectUri: "u:uuid:" + mssItem[0]._id, objectLiteral :  null,  literalDataType: null, prov: componentMmsProv  })
												...
												dereferenceMmsItem(databaseAgents,databaseTerms,databaseSerialized,databaseMmsCaptures,mssItem[0],function(defResults){
													...
													defResults.captures.map(function(c){
														...
														triples.push({  subject: captureUri,  predicate: "dcterms:identifier", objectUri: "u:superparent:" + collectionRegistryId, objectLiteral :  null,  literalDataType: null, prov: captureProv  })
														...
														triples.push({  subject: captureUri,  predicate: "dcterms:identifier", objectUri: "u:uuid:" + c.uuid, objectLiteral :  null,  literalDataType: null, prov: captureProv  })
														if (c.imageId){
															if (c.imageId!=""){
							...
							function(err, results) {
								...
								databaseMmsContainers.find({ collectionUuid : collection._id}).toArray(function(err, containers) {
									...
									async.eachSeries(containers, function(c, eachCallback) {
										...
										triples.push({  subject: containerUri,  predicate: "dcterms:identifier", objectUri: "u:superparent:" + collectionRegistryId, objectLiteral :  null,  literalDataType: null, prov: containerProv  })
										...
										itemCursor.on('data', function(item) {
											...
											triples.push({  subject: itemUri,  predicate: "dcterms:identifier", objectUri: "u:superparent:" + collectionRegistryId, objectLiteral :  null,  literalDataType: null, prov: itemProv  })
							...
							if (count==0){
								...
								shadowcatItem.find({bibIds:bib._id}).toArray(function(err,items){
									...
									barcode.map(function(b){
										triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:barcode:" + b, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
									})
									
									triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:bnum:" + bib._id, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
									...
									if (bib['sc:oclc']){
										bib['sc:oclc'].map(function(i){
											triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:oclc:" + i, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
										})
									}

									if (bib['sc:isbn']){
										bib['sc:isbn'].map(function(i){
											triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:isbn:" + i, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
										})
									}
									if (bib['sc:issn']){
										bib['sc:issn'].map(function(i){
											triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:issn:" + i, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
										})
									}
									if (bib['sc:hathi']){
										bib['sc:hathi'].map(function(i){
											triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:hathi:" + i, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
										})
									}
									...
									if (bib['sc:classmark']){
										bib['sc:classmark'].map(function(i){
											if (typeof i === 'string')
												triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:classmark:" + i.replace(/\s/g,''), objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
										})
									}

									if (bib['sc:callnumber']){
										bib['sc:callnumber'].map(function(i){
											triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:callnum:" + i.replace(/\s/g,''), objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
										})
									}

									if (bib['sc:lccCoarse']){
										triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:lccc:" + bib['sc:lccCoarse'], objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
									}

									if (bib['classify:owi']){
										triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:owi:" + bib['classify:owi'], objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
									}
									if (bib['classify:dcc']){
										triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:dcc:" + bib['classify:owi'], objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
									}
									if (bib['classify:lcc']){
										triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "u:lcc:" + bib['classify:owi'], objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
									}
										...
										if (v.marcTag=='008'){
											...
											if (v.content){
												...
												if (d1){
													...
													triples.push({  subject: collectionUri,  predicate: "dbo:yearStart", objectUri: null, objectLiteral :  d1,  literalDataType: "xsd:date", prov: collectionProv  })
