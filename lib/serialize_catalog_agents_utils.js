...
exports.mergeScAgentViafRegistryAgent = function(scAgent, viaf, registryAgent){
	...
	if (scAgent && !registryAgent){
		...
		if (viaf){
			...
			if (viaf.lcTerm){
				newAgent.nameControled = viaf.lcTerm
			}else if (viaf.viafTerm){
				newAgent.nameControled = viaf.viafTerm
			}else{
				newAgent.nameControled = scAgent.nameLocal
			}
			...
			if (scAgent.nameLc){
				newAgent.nameControled = scAgent.nameLc
			}else if (scAgent.nameViaf){
				newAgent.nameControled = scAgent.nameViaf
			}else{
				newAgent.nameControled = scAgent.nameLocal
			}
