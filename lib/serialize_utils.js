...
exports.serializeArchives = function(cb){
	...
	var totalTriples = 3868791, totalCollections = 0
...
// 									}
// 									if (bib['sc:lccCoarse']){
// 										bib['sc:lccCoarse'].map(function(i){
// 											triples.push({  subject: collectionUri,  predicate: "dcterms:identifier", objectUri: "urn:lccc:" + i, objectLiteral :  null,  literalDataType: null, prov: collectionProv  })
// 										})
// 									}
// 									if (bib['sc:classmark']){
