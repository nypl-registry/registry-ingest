					...
					function(err, results) {
						...
						componentCursor.on('data', function(component) {
							...
							function(err, results) {
								...
								//check against mms genre, name, subject, dates for any merged
								if (component.matchedMms){
									...
									if (component.matchedMmsType == 'containerMerge'){
										...
										databaseMmsItems.find({ archivesCollectionDb: component.mmsDb }).toArray(function(err, mssItem){

											console.log(component.title, mssItem.length)
