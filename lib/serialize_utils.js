...
exports.buildMmsTriples = function(mmsItem,defResults,collectionRegistryId){
	...
	mmsItem.abstracts.forEach(function(abstract){
		...
		mmsItemObj.addTriple( 'dcterms:description', null, exports.removeHtml(abstract),  null, "data:10002", mmsItem.uuid)
	})
...
exports.buildShadowcatTriples = function(bNumberSupplied, cb){
	...
	function(err, results) {
		...
		function(err, results) {
			...
			bibObj.addTriple( 'dcterms:identifier',   "resourcetypes:" + resourceType, null,  null, "data:10000", bib._id)
			...
			console.log(JSON.stringify(bibObj,null,1) )
