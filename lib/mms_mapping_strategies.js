...
exports.mapCollectionsToArchivesCollections = function(cb){
	...
	db.returnCollection("mmsCollections",function(err,mmsCollections,mmsDatabase){
		...
		db.returnCollection("archivesCollections",function(err,archiveCollections,archivesDatabase){
...
exports.mapItemsToArchivesComponentsByIdentifiers = function(cb){
	...
	db.returnCollection("mmsItems",function(err,mmsItems,mmsDatabase){
		...
		db.returnCollection("archivesComponents",function(err,archivesComponents,archivesDatabase){
...
exports.mapItemsToComponentsByRepoObjectTable = function(cb){
	...
	db.returnCollection("mmsItems",function(err,mmsItems,mmsDatabase){
		...
		db.returnCollection("mmsContainers",function(err,mmsContainers,mmsDatabase2){	
...
exports.returnMmsCollectionDetails = function(collectionObject,cb){
	...
	// db.returnCollection("mmsCollections",function(err,mmsCollections,mmsDatabase1){	

	// 	db.returnCollection("mmsContainers",function(err,mmsContainers,mmsDatabase2){	

	// 		db.returnCollection("mmsItems",function(err,mmsItems,mmsDatabase3){
				...
				async.each(data.itemMap, function(itemMap, eachCallback) {
					...
					mmsItems.update({ _id : update._id }, { $set: update }, function(err, result) {
						...
						var archivesUpdate = {
							...
							archivesCollectionDb: itemMap.uuid
						}
...
exports.mapItemsToTmsObjectsByImageId = function(cb){
	...
	db.returnCollection("mmsCaptures",function(err,mmsCaptures,mmsDatabase){

		db.returnCollection("mmsItems",function(err,mmsItems,mmsDatabase2){
