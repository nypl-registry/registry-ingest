												...
												serializeUtils.dereferenceMmsItem(databaseAgents,databaseTerms,databaseSerialized,databaseMmsCaptures,mssItem[0],function(defResults){
													...
													defResults.registryAgents.forEach(function(a){
														if (addedContriubtors.indexOf(a._id) == -1 && collectionLevelAgents.indexOf(a._id)==-1){
															...
															componentObj.addTriple( "dcterms:contributor", "agents:"+a.registry, null,  null, "data:10002", mssItem[0].uuid)
														}
													})
													defResults.registryTerms.forEach(function(a){
														if (addedSubjects.indexOf(a._id) == -1 && collectionLevelTerms.indexOf(a._id)==-1){
															...
															componentObj.addTriple( "dcterms:subject", "agents:"+a.registry, null,  null, "data:10002", mssItem[0].uuid)
														}
													})
