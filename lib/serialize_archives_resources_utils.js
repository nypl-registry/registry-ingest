			...
			databaseArchivesCollections.find({ _id : collectionId }).toArray(function(err, collection){
				...
				shadowcatBib.find({ _id : bNumber}).toArray(function(err, bibs) {
					...
					if (collection.mss){
						...
						collectionObj.addTriple( 'dcterms:identifier', "u:msscoll:" + collection.mss, null,  null, "data:10001", collection.mss)
					}
					if (collection.bNumber){
						...
						collectionObj.addTriple( 'dcterms:identifier', "u:bnum:" + collection.bNumber, null,  null, "data:10001", collection.mss)
					}
					if (collection.callNumber){
						...
						collectionObj.addTriple( 'dcterms:identifier', "u:callnum:" + collection.callNumber.replace(/\s/g,''), null,  null, "data:10001", collection.mss)
					}
					if (collection.matchedMms){
						...
						collectionObj.addTriple( 'dcterms:identifier', "u:uuid:" + collection.mmsUuid, null,  null, "data:10001", collection.mss)
					...
					collection.dates.forEach(function(d){
						if (parseInt(d.value)!= 0){
							if (d.point=='start'){
								...
								collectionObj.addTriple( 'dbo:yearStart', null, d.value,  "xsd:date", "data:10001", collection.mss)
							}
							if (d.point=='end'){
								...
								collectionObj.addTriple( 'dbo:yearEnd', null, d.value,  "xsd:date", "data:10001", collection.mss)
							}
							if (d.point=='exact'){
					...
					function(err, results) {
						...
						databaseMmsItems.find( { parents : collection.mmsUuid, matchedArchives: {$exists: false} } ).toArray(function(err, mssItems){
							...
							async.eachSeries(mssItems, function(aMssItem, eachCallback) {
								...
								serializeUtils.dereferenceMmsItem(databaseAgents,databaseTerms,databaseSerialized,databaseMmsCaptures,aMssItem,function(defResults){
									...
									results.mmsItemObj.addTriple( "dcterms:identifier", "u:superparent:" + collectionObj.uri, null,  null, "data:10002", aMssItem.uuid )
						...
						componentCursor.on('data', function(component) {
							...
							componentObj.addTriple( 'dcterms:identifier',  "u:superparent:" + collectionObj.uri, null,  null, "data:10001", component.mss)
							...
							if (component.mss){
								...
								componentObj.addTriple( 'dcterms:identifier', "u:mss:" + component.mss, null,  null, "data:10001", component.mss)
							}
							if (component.barcode){
								...
								componentObj.addTriple( 'dcterms:identifier', "u:barcode:" + component.barcode, null,  null, "data:10001", component.mss)
							}
							...
							component.dates.forEach(function(d){
								if (d.point=='start'){
									...
									componentObj.addTriple( 'dbo:yearStart', null, d.value,  "xsd:date", "data:10001", component.mss)
								}
								if (d.point=='end'){
									addedDates.push(d.value)
									...
									componentObj.addTriple( 'dbo:yearEnd', null, d.value,  "xsd:date", "data:10001", component.mss)
								}
								if (d.point=='exact'){
									addedDates.push(d.value)
									...
									if (component.matchedMmsType == 'containerMerge'){
										...
										databaseMmsItems.find( { parents : component.mmsUuid } ).toArray(function(err, mssItems){
											...
											async.eachSeries(mssItems, function(aMssItem, eachCallback) {
												...
												nyplItem.addTriple( 'dcterms:identifier', "u:superparent:" + collectionObj.uri, null,  null, "data:10002", aMssItem.uuid)
										...
										databaseMmsItems.find({ $or : [ { archivesComponentDb: component.mssDb }, { _id: component.mmsUuid}] }).toArray(function(err, mssItem){
											...
											if (mssItem.length==1){
												...
												componentObj.addTriple( "dcterms:identifier", "u:uuid:" + mssItem[0]._id, null,  null, "data:10002", mssItem[0].uuid)
												...
												serializeUtils.dereferenceMmsItem(databaseAgents,databaseTerms,databaseSerialized,databaseMmsCaptures,mssItem[0],function(defResults){
													...
													defResults.captures.forEach(function(c){
														...
														captureObj.addTriple( "dcterms:identifier", "u:superparent:" + collectionObj.uri, null,  null, "data:10002", c.uuid)
