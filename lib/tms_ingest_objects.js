...
exports.ingest = function(cb){
	...
	var tmsDepartmentsLookupMapping = config['Thesaurus']['tmsDepartments']
				...
				db.returnCollection("tmsObjects",function(err,collection,database){
					...
					file.streamCsvFile(tmsObjects, {}, function(record,recordCb){
						...
						if (!isNaN(objectDb)){
							...
							if (tmsDepartmentsLookupMapping[obj.DepartmentID.toString()]){
								insert.division =tmsDepartmentsLookupMapping[obj.DepartmentID.toString()]
							}
